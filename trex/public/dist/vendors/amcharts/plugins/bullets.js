...
am4internal_webpackJsonp(["2ff7"], {
    V3Xd: function(e, t, i) {
        ...
        a.b.registeredClasses.PointerCircle = c;
        var u = i("TXRX"),
            p = i("FzPm"),
            h = i("tjMS"),
            d = i("MIZb"),
            g = function(e) {
                ...
                return n.c(t, e), t.prototype.validate = function() {
                    ...
                    var V = this.image;
                    V ? (V.x = x, V.y = C, V.width = 2 * s, V.height = 2 * s, V.element.attr({
                        preserveAspectRatio: "xMidYMid slice"
                    }), this.circle && (this.circle.scale = 1 / V.scale)) : this.circle && (this.circle.x = x, this.circle.y = C);
                    var O = this.label;
                    O && (O.x = x, O.y = C)
        ...
        a.b.registeredClasses.PinBullet = g;
        var y = i("p9TX"),
            f = i("w4m0"),
            b = i("PTiM"),
            m = function(e) {
        ...
        a.b.registeredClasses.FlagBullet = m;
        var v = i("Vs7R"),
            P = i("Mtpk"),
            x = i("v9UT"),
            C = function(e) {
        ...
        a.b.registeredClasses.Star = C, window.am4plugins_bullets = r
    }
}, ["V3Xd"]);
