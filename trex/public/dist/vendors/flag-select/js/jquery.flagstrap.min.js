        ...
        var g = function() {
            ...
            p = function() {
                ...
                var i = a("<span/>").addClass("flagstrap-selected-" + s).html(t).append(e),
                    r = a("<button/>").attr("type", "button").attr("data-toggle", "dropdown").attr("id", "flagstrap-drop-down-" + s).addClass("btn py-2 " + o.settings.buttonType + " " + o.settings.buttonSize + " dropdown-toggle").html(i)
                return a("<span/>").addClass("caret").css("margin-left", o.settings.labelMargin).insertAfter(i), r
            },
            S = function() {
                var e = a("<ul/>").attr("id", "flagstrap-drop-down-" + s + "-list").attr("aria-labelled-by", "flagstrap-drop-down-" + s).addClass("dropdown-menu rounded-0")
