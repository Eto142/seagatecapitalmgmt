...
<head>
    <meta charset="utf-8" />
    <title>Seagatecapitalmgmt| ACCOUNT</title>
                ...
                <div class="col-lg-12">
                    <div class="text-center mb-5 text-muted">
                        <a href="index.html" class="d-block auth-logo">
                            <img src="{{asset('static/logo.png')}}" alt="" height="100" width="100"
            ...
            <div class="row justify-content-center">
                ...
                <div class="mt-5 text-center">
                    ...
                    <p>©
                        ...
                        <i class="bx bx-check-shield text-success"></i>Seagatecapitalmgmt
                    </p>
                </div>
