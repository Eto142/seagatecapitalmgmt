                        ...
                        <div class="table-responsive">
                            <table id="depositHistoryTable" class="display table dataTable table-striped table-bordered"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>{{ $deposit->id }}</td>
                                        <td>{{Auth::user()->currency}}{{ number_format($deposit->amount, 2) }}</td>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <form style="padding:3px;" role="form" method="post"
                                action="https://Seagatecapitalmgmt.com/dashboard/savevdocs" enctype="multipart/form-data">
                                <hr>
                                ...
                                <div class="col-auto">
                                    ...
                                    <div class="input-group mb-2">
                                        <div class="input-group-prepend">
                                            <div class="input-group-text">{{Auth::user()->currency}}</div>
                                        </div>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <center> <a class="btn btn-primary"
                                href="https://Seagatecapitalmgmt.com/dashboard/switchuser/">Proceed</a></center>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                    </div>
