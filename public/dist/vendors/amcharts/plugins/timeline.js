    ...
    vlr4: function(t, e, i) {
        ...
        var o = i("m4/l"),
            ...
            h = function(t) {
                ...
                return o.c(e, t), e.prototype.createDataItem = function() {
                    return new l
        ...
        a.b.registeredClasses.CurveLineSeries = h, a.b.registeredClasses.CurveLineSeriesDataItem = l;
        var c = i("C6dT"),
            d = i("k6kv"),
            y = i("xgTw"),
            f = i("hGwe"),
            ...
            m = function(t) {
                ...
                return o.c(e, t), Object.defineProperty(e.prototype, "axisLength", {
                    get: function() {
                    ...
                    if (e) {
                        ...
                        for (var b = this.axis.start, C = this.axis.end, A = Math.ceil(this.axisLength / this.precisionStep * (n - i) / (C - b)), T = 0; T <= A; T++) {
                            var R = i + T / A * (n - i),
                                S = (O = this.positionToPoint(R)).angle,
                                V = O.x + c * u.cos(S),
                                L = O.y + c * u.sin(S);
                            m += f.lineTo({
                                x: V,
                        ...
                        for (T = A; T >= 0; T--) {
                            var O;
                            R = i + T / A * (n - i), S = (O = this.positionToPoint(R)).angle, V = O.x + d * u.cos(S), L = O.y + d * u.sin(S);
                            m += f.lineTo({
                                x: V,
                                y: L
                            })
        ...
        a.b.registeredClasses.AxisRendererCurveX = m;
        var b = i("OXm9"),
            C = i("Vk33"),
            A = i("hD5A"),
            T = function(t) {
                ...
                return o.c(e, t), e.prototype.validate = function() {
        ...
        a.b.registeredClasses.AxisRendererCurveY = T;
        var R = i("Q4nc"),
            S = function(t) {
                function e() {
                    var e = t.call(this) || this;
            ...
            V = function(t) {
                ...
                return o.c(e, t), e.prototype.applyInternalDefaults = function() {
        ...
        a.b.registeredClasses.CurveChart = V;
        var L = i("tjMS"),
            O = i("v9UT"),
            I = function(t) {
                function e() {
            ...
            X = function(t) {
                function e() {
                    var e = t.call(this) || this;
                    return e.className = "SerpentineChart", e.orientation = "vertical", e.levelCount = 3, e.yAxisRadius = Object(L.c)(25), e.yAxisInnerRadius = Object(L.c)(-25), e.applyTheme(), e
                }
                return o.c(e, t), Object.defineProperty(e.prototype, "orientation", {
                    get: function() {
                    ...
                    var x = O.relativeRadiusToValue(this.yAxisInnerRadius, 2 * s),
                        g = O.relativeRadiusToValue(this.yAxisRadius, 2 * s);
                    this.yAxes.each(function(t) {
        ...
        a.b.registeredClasses.SerpentineChart = X;
        var j = function(t) {
                function e() {
                    var e = t.call(this) || this;
            ...
            Y = function(t) {
                function e() {
                    var e = t.call(this) || this;
                    return e.className = "SpiralChart", e.levelCount = 3, e.precisionStep = 5, e.startAngle = 0, e.endAngle = 0, e.innerRadius = Object(L.c)(25), e.yAxisRadius = Object(L.c)(35), e.yAxisInnerRadius = Object(L.c)(-35), e.inversed = !1, e.applyTheme(), e
                }
                return o.c(e, t), Object.defineProperty(e.prototype, "levelCount", {
                    get: function() {
                        return this.getPropertyValue("levelCount")
                    },
                    set: function(t) {
                    ...
                    var e = this.curveContainer,
                        ...
                        o = u.min(i, n) / 2,
                        s = this.radiusStep,
                        r = O.relativeRadiusToValue(this.innerRadius, o);
                    x.isNumber(s) || (s = (o - r) / this.levelCount);
                    var a = f.spiralPoints(0, 0, o, o, r, this.precisionStep, s, this.startAngle, this.endAngle),
                        p = O.relativeRadiusToValue(this.yAxisInnerRadius, s),
                        l = O.relativeRadiusToValue(this.yAxisRadius, s);
        ...
        a.b.registeredClasses.SpiralChart = Y;
        var M = i("5vid"),
            k = function(t) {
                function e() {
                    var e = t.call(this) || this;
                ...
                return o.c(e, t), e.prototype.createAssets = function() {
        ...
        a.b.registeredClasses.CurveColumn = k;
        var w = i("pR7v"),
            _ = i("VB2N"),
            N = function(t) {
                function e() {
            ...
            D = function(t) {
                ...
                return o.c(e, t), e.prototype.createColumnTemplate = function() {
                    return new k
                    ...
                    if (this.baseAxis == this.xAxis) {
                        ...
                        var S = {
                            ...
                            L = t.locations[o],
                            O = t.locations[s];
                        this.xAxis instanceof w.a && this.dataFields[this.xField] != this.dataFields[this.xOpenField] && (L = 0, O = 0);
                        var I = y.getPositionX(t, s, O, "valueX", S),
                            X = y.getPositionX(t, o, L, "valueX", S),
                            j = v.getPositionY(t, n, r, "valueY", V),
                            Y = v.getPositionY(t, i, a, "valueY", V);
                        m = (X - I) / (Math.ceil(y.axisLength / P.precisionStep * (X - I) / (y.end - y.start)) + 2);
                        if (X > I) {
                            for (T = I; T <= X; T += m) T > X && (T = X), d.push(y.renderer.positionToPoint(T, j));
                            d.push(y.renderer.positionToPoint(X, j));
                            for (T = X; T >= I; T -= m) T < I && (T = I), d.push(y.renderer.positionToPoint(T, Y));
                            d.push(y.renderer.positionToPoint(I, Y))
                        }
                        c = y.renderer.positionToPoint(I + (X - I) / 2, j + (Y - j) / 2)
                    }
                    var M = t.column;
        ...
        a.b.registeredClasses.CurveColumnSeries = D, a.b.registeredClasses.CurveColumnSeriesDataItem = N;
        var B = i("KknQ"),
            E = function(t) {
                function e() {
                    var e = t.call(this) || this;
        ...
        a.b.registeredClasses.CurveStepLineSeries = F, a.b.registeredClasses.CurveStepLineSeriesDataItem = E;
        var G = function(t) {
            function e() {
                var e = t.call(this) || this;
                return e.className = "CurveCursor", e.applyTheme(), e.mask = void 0, e
            }
            return o.c(e, t), e.prototype.fitsToBounds = function(t) {
        ...
        a.b.registeredClasses.CurveCursor = G, window.am4plugins_timeline = n
    }
}, ["vlr4"]);
